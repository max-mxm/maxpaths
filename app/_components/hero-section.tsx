      ...
      <div className="container relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-7 space-y-5 lg:space-y-8 text-center lg:text-left">
            ...
            {/* H1 */}
            <h1 className="text-[clamp(2rem,6vw,4.5rem)] font-black leading-[1.05] tracking-tight text-foreground">
              Bonnes pratiques
              <br />
            ...
            {/* Subtitle */}
            <p className="text-[clamp(1rem,2vw,1.375rem)] text-muted-foreground leading-relaxed max-w-2xl mx-auto lg:mx-0">
        ...
        {/* Stats bar */}
        <div className="flex flex-wrap gap-6 sm:gap-12 pt-8 mt-8 md:pt-12 md:mt-12 border-t border-border/50 justify-center lg:justify-start">
          <div>
            <div className="text-2xl sm:text-3xl font-black text-foreground">8+ ans</div>
            <div className="text-sm text-muted-foreground mt-1">d&apos;experience terrain</div>
          </div>
          <div>
            <div className="text-2xl sm:text-3xl font-black text-foreground">4 guides</div>
            <div className="text-sm text-muted-foreground mt-1">techniques complets</div>
          </div>
          <div>
            <div className="text-2xl sm:text-3xl font-black text-foreground">60+</div>
