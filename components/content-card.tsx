...
export function ContentCard({
  ...
  return (
    <Link
      href={href}
      className="group block rounded-xl border border-border/50 bg-card p-6 transition-all duration-300 hover:shadow-lg hover:-translate-y-0.5"
    ...
    >
      <div className="flex h-full flex-col">
        ...
        {/* Title */}
        <h3 className="text-xl font-bold leading-tight mb-3 transition-colors duration-200 group-hover:text-primary">
          {title}
        </h3>
